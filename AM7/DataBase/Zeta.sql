...
--
-- Host: localhost:3306
-- Generation Time: Sep 05, 2017 at 07:32 PM
...
INSERT INTO `submittions` (`id`, `user_id`, `problem`, `language`, `time`, `response`, `solution`) VALUES
(144, 78, 'Card Game', '', '2017-09-04 14:22:21', '--', 'wqe'),
(145, 78, 'Shortest path of the king', '', '2017-09-04 14:23:04', 'Compilation Error', 'ghhfkjkkkkkkkkkkkkk'),
(146, 78, 'Shortest path of the king', 'C++', '2017-09-05 10:16:18', '--', 'sadsa'),
(147, 78, 'Shortest path of the king', 'Java', '2017-09-05 10:24:42', '--', 'sas');
